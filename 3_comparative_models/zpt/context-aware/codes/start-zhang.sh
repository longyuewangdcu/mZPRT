...
save_dir=/models/open_sub/Zhangdoc
log_dir=/log/open_sub/Zhangdoc
user_dir=./
SPM=/models/open_sub/SAN/checkpoint_best.pt
mkdir ${log_dir}
mkdir ${output}
output=${output}/opensub.big.batch.zhang
source ~/.bashrc
conda activate base
...
fairseq-train $data_dir \
	...
	-s zh -t en \
	--task multi-enc \
	--arch zhangdoc_vaswani_wmt_en_de_big \
	...
	--dropout 0.4 --attention-dropout 0.1 --weight-decay 0.00001 \
	--max-update 60000 \
	...
	--ddp-backend=no_c10d |tee ${log_dir}/opensub-big-batch-zhang-doc-fp16.log
